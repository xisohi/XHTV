...
public class Github {
    ...
    private static final String[] PROXY_URLS = {
            ...
            "https://mirror.ghproxy.com/",      // 备用节点多
            "https://kgithub.com/",             // 国内备案
            "https://gh.api.99988866.xyz/"      // 个人维护（最后备用）
    };
    ...
    /**
     * APK 下载地址（GitHub Releases 带代理加速）
     * 示例: https://github.com/xisohi/XHYSosc/releases/download/lkys/lkys-arm64_v8a.apk
     *
     * @param name APK文件名（含架构信息，如 lkys-arm64_v8a）
