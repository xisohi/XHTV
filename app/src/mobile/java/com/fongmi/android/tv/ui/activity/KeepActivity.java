...
public class KeepActivity extends BaseActivity implements KeepAdapter.OnClickListener {
    ...
    private void onDelete() {
        if (mAdapter.isDelete()) {
            new MaterialAlertDialogBuilder(Util.wrapContext(this)).setTitle(R.string.dialog_delete_record).setMessage(R.string.dialog_delete_keep).setNegativeButton(R.string.dialog_negative, null).setPositiveButton(R.string.dialog_positive, (dialog, which) -> mAdapter.clear()).show();
